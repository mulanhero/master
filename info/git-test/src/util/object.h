 ...
 * ----------------------------------------------------
 * 1) 一个类 = struct + class descriptor
 * 2) struct的第一个element必须是 parent's descriptor
 * 3) 若struct的名字为	sally_t, 则其class descriptor的名字为sally_t_class,
 * 	 且statically initialized
 * ----------------------------------------------------
